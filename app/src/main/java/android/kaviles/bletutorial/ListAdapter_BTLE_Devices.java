...
import android.kaviles.bletutorial.model.RSSItoRange;
...
public class ListAdapter_BTLE_Devices extends ArrayAdapter<BTLE_Device> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        double distance = RSSItoRange.getDistanceFromRssi(device.getRSSI());
        ...
        TextView distanceTextView = (TextView)convertView.findViewById(R.id.distance_text_view);
